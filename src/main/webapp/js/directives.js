    ...
    .directive('jsonTo', function ($compile) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                var build = function(to, history) {
                    ...
                    switch (to.type) {
                        ...
                        case 'collection':
                            ...
                            html += build(to.typeValue, history);
                            html += '</li></ul>';
                            html += '<span>]</span>';
                            break;
                 ...
                 */
                 function buildComplexToProperties(to, history, listedProperties) {
                    ...
                    _.each(to.content, function(field) {
                        if (listedProperties.indexOf(field.name) < 0) {
                            html += '<li class="parameterItem"><span class="parameterName">' + field.name + ': </span>';
                            html += build(field.typeValue, history);
                            html += "</li>";
                ...
                var newElement = angular.element(build(scope.to));
